package hard.largestGap;

/** 
================================= 
TestGen 3.1 for JUnit 4.13.0 		
Test Case: Stretches::largestGap 
Timestamp: 10/23/2020 07:03:44 AM 
--------------------------------- 
® DARKKO 2021 © 
================================= 
...
public class StretchesTest {
    ...
    public void test05() {
        assertEquals(9,
                Stretches.largestGap(new int[] { 26, 17, 4, 25, 29, 26, 8, 30, 4, 20, 2, 7, 29, 7, 20, 30, 23, 5 }));
    }
