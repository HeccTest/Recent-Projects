...
def chase(): # can implement a much more sophisticated solution (mathematical) to chase after Tim the turtle
    chaser.setheading(tim.heading())
    chaser.forward(5)
    if(tim.distance(chaser) < 10):
        print("Chaser caught Tim")
